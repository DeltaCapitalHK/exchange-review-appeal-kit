...
本仓库帮助用户在遇到交易所账户限制、风控审核、提现延迟、资金来源审查或补充材料要求时，把事实、时间线、资金来源、交易路径和证据整理成清晰的申诉材料包。

本工具包不是交易所官方流程，不用于绕过风控，不承诺百分百实现解冻、放款、提现通过或追回成功。它的作用是帮助用户更清楚地准备材料、解释事实、减少无效沟通。

## 常见搜索问题

如果你正在搜索下面这些问题，本工具包可能能帮助你整理材料：
...
- OKX C2C 资金被锁定怎么办
- Bybit 账户限制怎么申诉
- Coinbase 账户 under review 怎么办
- Kraken 账户被冻结需要准备什么
- Gate / KuCoin / Bitget 提现审核要提交什么材料
- 交易所要求资金来源说明怎么写
- 虚拟币账户被冻结如何整理证据
- USDT 提现审核、风控、冻结后怎么准备申诉材料
...
- 公开资料采用 [CC BY 4.0](LICENSE) 授权。
- 引用信息见 [CITATION.cff](CITATION.cff)。
- 文档修正可通过 GitHub Issue 模板提交。请勿提交私人案件材料。

## 关于德尔泰（Delta&Capital）

德尔泰为数字资产相关事件提供链上交易分析、证据整理、风险评估、交易所账号冻结/风控 申诉与解冻协助、合规支持，以及被盗、被骗资产追回协助与支持。
