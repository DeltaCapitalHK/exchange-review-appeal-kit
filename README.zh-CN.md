...
本工具包不是交易所官方流程，不用于绕过风控，不承诺解冻、放款、提现通过或追回成功。它的作用是帮助用户更清楚地准备材料、解释事实、减少无效沟通。
...
德尔泰（Delta&Capital）可协助用户进行材料整理、事实说明、链上交易分析、证据目录制作及交易所审核/申诉流程准备，但不承诺账户恢复、提现通过、资金释放、资产追回或任何由交易所、平台、执法机构及第三方决定的结果。
